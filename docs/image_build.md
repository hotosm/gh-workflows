...
| <a name="input_environment"></a>[environment](#input_environment)                | boolean | false    | ``             | Environment to extract variables and <br>secrets from and pass to <br>extra_build_args.       |
