...
| <a name="input_debug_override"></a>[debug_override](#input_debug_override)                      | boolean | false    | `false`                | Allow overriding the DEBUG environment <br>variable in the compose file.                          |
